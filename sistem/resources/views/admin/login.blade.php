...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="{{url('public')}}/_srcadmin/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!--external css-->
  <link href="{{url('public')}}/_srcadmin/lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
  <!-- Custom styles for this template -->
  <link href="{{url('public')}}/_srcadmin/css/style.css" rel="stylesheet">
  <link href="{{url('public')}}/_srcadmin/css/style-responsive.css" rel="stylesheet">
